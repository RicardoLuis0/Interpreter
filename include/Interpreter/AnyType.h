...
namespace Interpreter {
    class AnyType : public Type {
        bool true_any;
    public:
        AnyType(bool is_const=false,bool true_any=false);
        ...
        virtual bool allows_implicit_cast(std::shared_ptr<Type> self,std::shared_ptr<Type> other) override;
        virtual bool has_cast(std::shared_ptr<Type> self,std::shared_ptr<Type> other) override;
