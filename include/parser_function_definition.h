...
namespace Parser{
    class FunctionDefinition : public ParserResultPart {
        public:
            FunctionDefinition(std::shared_ptr<VarType> return_type,std::shared_ptr<Lexer::WordToken>,std::vector<std::shared_ptr<FunctionDefinitionParameter>>,std::shared_ptr<CodeBlock> code,int line_start,int line_end);
